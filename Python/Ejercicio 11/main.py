...
#
# Una vez creada la tabla, tenéis que insertarle datos, como mínimo tenéis que insertar
# 8 alumnos a la tabla.
#
# Por último, tienes que realizar una búsqueda de un alumno por nombre y mostrar los
# datos por consola.
